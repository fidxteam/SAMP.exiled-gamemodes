...
CreateJoinKurirPoint()
{
    //JOBS
    new strings[128];
    CreateDynamicPickup(1239, 23, 988.890563, -1349.136962, 13.545228, -1);
    format(strings, sizeof(strings), "[KURIR JOBS]\n{ffffff}Jadilah Pekerja Kurir disini\n{7fffd4}/getjob /accept job");
    CreateDynamic3DTextLabel(strings, COLOR_YELLOW, 988.890563, -1349.136962, 13.545228, 3.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1); // Kurir
}
