...
CMD:fare(playerid, params[])
{
	...
	if(pData[playerid][pFare] == 0)
	{
		...
		TextDrawShowForPlayer(playerid, TaxiTDX[playerid]);
		...
		//passanger
		TextDrawShowForPlayer(GetVehiclePassenger(vehicleid), TaxiTDX[playerid]);
	...
	else
	{
		...
		TextDrawHideForPlayer(GetVehiclePassenger(vehicleid), TaxiTDX[playerid]);
